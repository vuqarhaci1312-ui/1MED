/**
 * Əlavə 11 geniş məqalə (id 100–110). Tarixlər data faylında: aprel 13–23, 2026.
 */
import fs from "fs";
import path from "path";
import { fileURLToPath } from "url";
import { APR24_MAY04_2026_POSTS } from "./apr24-may04-2026-posts-data.mjs";
...
const POSTS = APR24_MAY04_2026_POSTS;
...
if (existingData.some((b) => b.id === 110)) {
  console.log("Bu partiya artıq əlavə olunub (id 110). Çıxılır.");
  process.exit(0);
}
